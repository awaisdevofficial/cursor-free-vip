...
function Get-LatestVersion {
    try {
        $latestRelease = Invoke-RestMethod -Uri "https://api.github.com/repos/muhammad-awais/cursor-free-vip/releases/latest"
        return @{
...
Write-Host "Created by Muhammad Awais`n" -ForegroundColor $Theme.Info
